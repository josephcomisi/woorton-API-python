...
setup(
    ...
    packages=['venv.lib.python2.7.distutils', 'venv.lib.python2.7.encodings', 'venv.lib.python2.7.site-packages.pip',
              ...
              'venv.lib.python2.7.site-packages.chardet.cli', 'venv.lib.python2.7.site-packages.urllib3',
              ...
              'venv.lib.python2.7.site-packages.requests', 'venv.lib.python2.7.site-packages.setuptools',
    ...
    license='',
    author='joseph',
    author_email='joseph@woorton.com',
    description='Woorton API implementation'
)
